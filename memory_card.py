...
questions_list.append(Question("Как будет картошка по меанкиели?", "Pottu", "Potato", "Potatis", "Potomantis"))
questions_list.append(Question("В какой стране мужчины носят юбки?", "Шотландия", "Ирландия", "Россия", "Швеция"))
questions_list.append(Question("В какой стране придумали марку Volvo?", "В Швеции", "В Дании", "В Латвии", "В Японии"))
questions_list.append(Question("Какая страна самая большая по площади в мире?", "Россия", "США", "Китай", "Канада"))
questions_list.append(Question("В каком океане плавает больше всего мусора?", "В Тихом океане", "В Атлантическом океане", "В Индийском океане", "В Северно ледовитом океане"))
